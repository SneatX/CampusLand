...
def validar_numeros(etiqueta, a, b):
    while True:
        try:
            ...
            print("El numero a ingresar debe ser entero.")
    return dato
factura = [["nombre" , "cantidad" , "valor u" , "valor f"]]
cli_mas = 0
cli_fem = 0
...
for i in range (N):
    ...
    for x in range(M):
        factura_cliente = []
        factura_cliente.append(nombre_cliente)
        ...
        factura_cliente.append(cantidad_producto)
        valor_unitario = validar_enteros("Ingrese el valor unitario del producto: $")
        factura_cliente.append(valor_unitario)
        ...
        factura_cliente.append(valor_final_producto)
        ...
        factura.append(factura_cliente)
...
for fila in range (len(factura)):
    for colu in range (len(factura[fila])):
        print(factura[fila][colu], end="\t")
    print("")
